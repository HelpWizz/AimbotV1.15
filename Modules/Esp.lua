...
if not getgenv().SympleHub or getgenv().SympleHub.Esp then return end
...
local Environment = getgenv().SympleHub.Esp
...
function Environment.Functions:Exit()
	...
	getgenv().SympleHub.Esp.Functions = nil
	getgenv().SympleHub.Esp = nil
