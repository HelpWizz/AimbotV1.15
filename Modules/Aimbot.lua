...
if not getgenv().SympleHub or getgenv().SympleHub.Aimbot then return end
...
local Environment = getgenv().SympleHub.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().SympleHub.Aimbot.Functions = nil
	getgenv().SympleHub.Aimbot = nil
